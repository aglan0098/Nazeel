...
function FastCreate() {
  ...
  return (
    <>
      ...
      {/* التسكين */}
      <div className="shadow-md rounded-2xl my-5">
        <h2 className="text-xl border-b-2 border-gray-200 p-4">التسكين</h2>

        <div className="grid sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-5 w-full my-7 p-7">
          <div className="mb-5 md:mb-2">
            <label htmlFor="" className="mb-2 block">
              المجمع
              <span className="text-red-500 mr-2">*</span>
            ...
            <div className="relative">
              ...
              >
                <option value="">اختر..</option>
                <option value="option1">المجمع الأول</option>
                <option value="option1">المجمع الثاني</option>
                <option value="option1">المجمع الثالث</option>
                <option value="option1">المجمع الرابع</option>
              </select>
